...
window.bdms || function () {
    ...
    !function () {
        ...
        !function (e, r, t) {
            ...
            0: Symbol,
            get 1() {
                return void 0 !== require.g ? require.g : void 0
            },
            2: Object,
            get 3() {
        ...
        var ge = ue;
        var me, __init, we = "__ac_referer";

        function Ie() {
            var e = function (key) {
                try {
                    var r = "";
                    window.sessionStorage && (r = window.sessionStorage.getItem(key) || "") || window.localStorage && (r = window.localStorage.getItem(key) || "") || (r = function (e, r) {
                        if ("string" == typeof r) {
        ...
        !function (__str__, r, t) {
            debugger

            function a(__str__, pos) {
                let t = parseInt(__str__.slice(pos, pos + 2), 16);
                if (t >>> 7 == 0) {
                    return [1, t]
                } else if (t >>> 6 == 2) {
                    t = (63 & t) << 8
                    return [2, t += parseInt(__str__.slice(pos + 2, pos + 4), 16)]
                } else {
                    t = (63 & t) << 16
                    return [3, t += parseInt(__str__.slice(pos + 2, pos + 6), 16)]
                }
            }
            ...
            if (0 !== parseInt(__str__.slice(16, 18), 16)) {
                throw new Error("ve")
            }
            for (n = 0; n < 4; ++n) {
                c += (3 & parseInt(__str__.slice(24 + 2 * n, 26 + 2 * n), 16)) << 2 * n;
            }
            var u = parseInt(__str__.slice(32, 40), 16)
            var b = 2 * parseInt(__str__.slice(48, 56), 16);
            for (n = 56; n < b + 56; n += 2) {
                i.push(parseInt(__str__.slice(n, n + 2), 16))
            }
            var d = b + 56
            var l = parseInt(__str__.slice(d, d + 4), 16);
            for (d += 4, n = 0; n < l; ++n) {
                var p = a(__str__, d);
                d += 2 * p[0];
                for (var h = "", v = 0; v < p[1]; ++v) {
