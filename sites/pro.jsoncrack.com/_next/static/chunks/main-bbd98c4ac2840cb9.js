...
self.webpackChunk_N_E.push([
    [179],
    {
        ...
        66870: function (module, exports, require) {
            "use strict";
            let router, o, a, i, u, l, s, c, f, d, p, h;
            ...
            class Y extends y.default.Component {
                ...
                componentDidMount() {
                    this.scrollToHash(),
                    router.isSsr && (o.isFallback || o.nextExport && ((0,
                        j.isDynamicRoute)(router.pathname) || location.search || X) || o.props && o.props.__N_SSG && (location.search || X)) && router.replace(router.pathname + "?" + String((0,
                        O.assign)((0,
                        O.urlQueryToSearchParams)(router.query), new URLSearchParams(location.search))), a, {
                        _h: 1,
            ...
            async function initialize(e) {
                ...
                (0,
                    ...
                    D.removeBasePath)(a)),
                    o.scriptLoader) {
                    let {initScriptLoader: e} = require(23114);
                    e(o.scriptLoader)
                }
                ...
                return window.__NEXT_P && window.__NEXT_P.map(e => setTimeout(() => s(e), 0)),
                    ...
                    (l = (0,
                        M.default)()).getIsSsr = () => router.isSsr,
            ...
            function J(e) {
                ...
                let {children: r} = e
                    ...
                    B.adaptForAppRouterInstance)(router), []);
                return (0,
                    g.jsx)(Y, {
                    fn: e => Z({
                        App: f,
                        ...
                        children: (0,
                            ...
                            children: (0,
                                ...
                                children: (0,
                                    ...
                                    value: (0,
                                        B.adaptForPathParams)(router),
                                    children: (0,
                                        g.jsx)(E.RouterContext.Provider, {
                                        value: (0,
                                            A.makePublicRouterInstance)(router),
                                        children: (0,
            ...
            function Z(e) {
                ...
                return console.error(u),
                    ...
                    i.loadPage("/_error").then(n => {
                            ...
                            return (null == s ? void 0 : s.Component) === o ? Promise.resolve().then(() => m._(require(928))).then(n => Promise.resolve().then(() => m._(require(17547))).then(r => (t = r.default,
                                e.App = t,
                                n))).then(e => ({
            ...
            async function hydrate(e) {
                ...
                window.__NEXT_PRELOADREADY && await window.__NEXT_PRELOADREADY(o.dynamicIds),
                    ...
                    X = await router._initialMatchesMiddlewarePromise;
                let r = {
                    App: f,
                    initial: !0,
                    Component: p,
        ...
        28731: function (module, exports, require) {
            "use strict";
            Object.defineProperty(exports, "__esModule", {
                value: !0
            })
                ...
                async getRouteInfo(e) {
                    ...
                    try {
                        ...
                        h && (w ? w.json = self.__NEXT_DATA__.props : w = {
                            ...
                            e(),
                        (null == w ? void 0 : null == (b = w.effect) ? void 0 : b.type) === "redirect-internal" || (null == w ? void 0 : null == (v = w.effect) ? void 0 : v.type) === "redirect-external")
                            return w.effect;
        ...
        62835: function (e) {
            var t, r, n, o, a, i, u, l, s, c, f, d, p, h, m, _, g, y, b, v, P, E, S, j, O, w, R, T, M, x, I, C, A, L, N,
                D,
                k, F, B, U, H, W, q, G, z, V;
            (t = {}).d = function (e, r) {
                for (var n in r)
                ...
                T = function (e) {
                    if (e.cancelable) {
                        ...
                        "pointerdown" == e.type ? (t = function () {
                            ...
                            addEventListener("pointercancel", r, j)) : w(o, e)
                    }
                }
                ,
                M = function (e) {
    ...
    function (require) {
        require.O(0, [9774], function () {
            return require(require.s = 28731)
        })
        _N_E = require.O()
    }
])
